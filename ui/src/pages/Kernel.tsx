...
import { apiClient, type KernelStatus, type KernelTelemetry } from "../api/client";
...
export function Kernel() {
  ...
  useEffect(() => {
    Promise.all([apiClient.kernelStatus(), apiClient.kernelTelemetry()])
      .then(([s, t]) => {
        setStatus(s);
        setTelemetry(t);
        setError(null);
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold">Kernel Guardian</h2>
